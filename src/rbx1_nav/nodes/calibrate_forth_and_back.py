    ...
    def __init__(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.start_test:
                ...
                # self.test_distance *= reverse
                self.test_distance = copysign(self.test_distance, reverse)
                print "test dist: ", self.test_distance
                # Compute the Euclidean distance from the target point
                distance = sqrt(pow((self.position.x - x_start), 2) +
                                pow((self.position.y - y_start), 2))
                distance = copysign(distance, reverse)
                print distance
                ...
                # change move direction between turns
                reverse = -reverse
